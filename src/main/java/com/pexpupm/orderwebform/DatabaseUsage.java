...
public class DatabaseUsage implements CommandLineRunner {
	...
	public void run(String ...args) throws Exception {
		...
		// This code allows to insert some persisted elements on the database
		// for testing purposes before main logic is executed
...
//		}
		...
		// This code shows how to delete complete deliveries or elements for a delivery
